    ...
    <div className="grid gap-8 lg:gap-12">
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400">We'll automatically detect the language.</p>
        </div>
        <div className="space-y-2">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div
              ...
              id="output"
            >
              <p className="text-sm text-gray-500 dark:text-gray-400">Translation will appear here.</p>
            </div>
          </div>
        </div>
      </div>
      <div className="space-y-2">
        <div className="space-y-2">
          <label className="text-sm font-medium leading-none" htmlFor="language">
            Translate to
          </label>
          <div className="w-[200px] rounded-md border border-gray-200 grid transition-colors dark:border-gray-800">
            <select className="w-full appearance-none p-3" defaultValue="es" id="language">
